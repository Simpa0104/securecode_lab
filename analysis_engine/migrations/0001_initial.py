    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='analisis', to='projects.project')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('analisis', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='vulnerabilidades', to='analysis_engine.analisis')),
            ],
            options={
