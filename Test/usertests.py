...
class GestionUsuariosTests(TestCase):
    ...
    def test_estudiante_no_puede_ver_gestion_usuarios(self):
        """Un estudiante no puede acceder a la gestión de usuarios."""
        self.client.login(username='est1', password='pass1234seguro')
        resp = self.client.get(reverse('gestion_usuarios'))
        self.assertNotEqual(resp.status_code, 200)  # ← esta línea estaba mal
